    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('master_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/lantais*") ? "menu-open" : "" }} {{ request()->is("admin/ruangs*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                ...
                @endcan
                @can('log_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/log-pinjams*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            <i class="fa-fw nav-icon fas fa-cogs">
                        ...
                        <ul class="nav nav-treeview">
                            @can('log_pinjam_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.log-pinjams.index") }}" class="nav-link {{ request()->is("admin/log-pinjams") || request()->is("admin/log-pinjams/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
